...
var BiuImg = function () {
  ...
  _createClass(BiuImg, [{
    ...
    value: function push(key) {
      ...
      var left = void 0;
      if (this.lastImg) {
        var bcr = this.lastImg.getBoundingClientRect();
        // 保证屏幕上只有一个图      
        if (!this.multi && bcr.left > 0) {
          return;
        }
        var rightBorderPos = bcr.left + bcr.width;
      ...
      Object.assign(img.style, this.imgStyle, { left: left });
      img.src = item.src;
      ...
      img.onload = function () {
        ...
        img.addEventListener('animationend', function () {
          _this.container.removeChild(img);
        }, false);
